                            ...
                            <tbody>
                                @foreach ($results as $key=>$item)
                                    <tr>
                                        ...
                                        <td>{{ Fungsi::get_team_from_league($item->team_home_id) }}</td>
                                        <td>{{ Fungsi::get_team_from_league($item->team_away_id) }}</td>
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-12">
                                ...
                                <select class="form-select" name="stage" id="stage" required>
                                    ...
                                    <option value="last 32">last 32</option>
