<x-app-layout>
    <div class="pc-content">
        <div class="row">
            <div class="col-12">
                <div class="bg-blue-800 card welcome-banner">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="p-4">
            ...
            <div class="col-md-6 col-xxl-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="p-3 mt-3 rounded bg-body">
                            <div class="mt-3 row align-items-center">
                                ...
                                <div class="col-5">
                                    ...
                                    <p class="mb-0 text-primary"><i class="ti ti-arrow-up-right"></i> 30.6%</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="p-3 mt-3 rounded bg-body">
                            <div class="mt-3 row align-items-center">
                                ...
                                <div class="col-5">
                                    ...
                                    <p class="mb-0 text-warning"><i class="ti ti-arrow-up-right"></i> 30.6%</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="p-3 mt-3 rounded bg-body">
                            <div class="mt-3 row align-items-center">
                                ...
                                <div class="col-5">
                                    ...
                                    <p class="mb-0 text-success"><i class="ti ti-arrow-up-right"></i> New</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="p-3 mt-3 rounded bg-body">
                            <div class="mt-3 row align-items-center">
                                ...
                                <div class="col-5">
                                    ...
                                    <p class="mb-0 text-danger"><i class="ti ti-arrow-up-right"></i> 30.6%</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-9">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h5 class="my-2 text-end">5.44% <span class="badge bg-success">+2.6%</span> </h5>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <span class="visually-hidden">New alerts</span>
                                    ...
                                    <div class="badge bg-light-secondary f-12"><i class="text-sm ti ti-paperclip"></i> 2</div>
                                </div>
                            </a>
                            <a href="#" class="btn btn-link-secondary">
                                <div class="d-flex align-items-center">
                        ...
                        <div class="mt-3 d-grid">
                            <button class="gap-2 btn btn-primary d-flex align-items-center justify-content-center"><i class="ti ti-plus"></i> Add task</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row align-items-center justify-content-center">
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="mt-3 d-grid">
                                    <button class="gap-2 btn btn-primary d-flex align-items-center justify-content-center"><i class="ti ti-plus"></i> Add project</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-4 d-flex align-items-center justify-content-between">
                            <div class="user-group able-user-group">
                                ...
                                <span class="text-sm avtar bg-light-primary text-primary">+2</span>
                            </div>
                        ...
                        <div class="tab-pane fade show active" id="analytics-tab-1-pane" role="tabpanel" aria-labelledby="analytics-tab-1" tabindex="0">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <div class="border avtar avtar-s"> AI </div>
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                            <div class="row g-1">
                                                <div class="col-6">
                                                    <h6 class="mb-0">Apple Inc.</h6>
                                                    <p class="mb-0 text-muted"><small>#ABLE-PRO-T00232</small></p>
                                                </div>
                                                <div class="col-6 text-end">
                                                    <h6 class="mb-1">$210,000</h6>
                                                    <p class="mb-0 text-danger"><i class="ti ti-arrow-down-left"></i> 10.6%</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <li class="list-group-item">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <div class="border avtar avtar-s" data-bs-toggle="tooltip" data-bs-title="10,000 Tracks"><span>SM</span></div>
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                            <div class="row g-1">
                                                <div class="col-6">
                                                    <h6 class="mb-0">Spotify Music</h6>
                                                    <p class="mb-0 text-muted"><small>#ABLE-PRO-T10232</small></p>
                                                </div>
                                                <div class="col-6 text-end">
                                                    <h6 class="mb-1">- 10,000</h6>
                                                    <p class="mb-0 text-success"><i class="ti ti-arrow-up-right"></i> 30.6%</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <li class="list-group-item">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <div class="border avtar avtar-s bg-light-primary" data-bs-toggle="tooltip" data-bs-title="143 Posts"><span>MD</span>
                                            </div>
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                            <div class="row g-1">
                                                <div class="col-6">
                                                    ...
                                                    <p class="mb-0 text-muted"><small>06:30 pm</small></p>
                                                </div>
                                                <div class="col-6 text-end">
                                                    <h6 class="mb-1">-26</h6>
                                                    <p class="mb-0 text-warning"><i class="ti ti-arrows-left-right"></i> 5%</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <li class="list-group-item">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <div class="border avtar avtar-s" data-bs-toggle="tooltip" data-bs-title="143 Posts"><span>U</span> </div>
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                            <div class="row g-1">
                                                <div class="col-6">
                                                    <h6 class="mb-0">Uber</h6>
                                                    <p class="mb-0 text-muted"><small>08:40 pm</small></p>
                                                </div>
                                                <div class="col-6 text-end">
                                                    <h6 class="mb-1">+210,000</h6>
                                                    <p class="mb-0 text-success"><i class="ti ti-arrow-up-right"></i> 10.6%</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <li class="list-group-item">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <div class="border avtar avtar-s bg-light-warning" data-bs-toggle="tooltip" data-bs-title="143 Posts"><span>OC</span>
                                            </div>
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                            <div class="row g-1">
                                                <div class="col-6">
                                                    ...
                                                    <p class="mb-0 text-muted"><small>07:40 pm</small></p>
                                                </div>
                                                <div class="col-6 text-end">
                                                    <h6 class="mb-1">+210,000</h6>
                                                    <p class="mb-0 text-success"><i class="ti ti-arrow-up-right"></i> 10.6%</p>
